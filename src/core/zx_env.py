...
class ZXRewriteEnv(gym.Env):
    ...
    def __init__(self, circuit_name=None, graphml_path=None, max_steps=50):
        ...
        self.original_tcount = 0
        self.current_tcount = 0
        ...
        if graphml_path:
            ...
            self.graph = nx.random_graphs.erdos_renyi_graph(10, 0.2)
            self.original_graph = copy.deepcopy(self.graph)
            self.original_tcount = self.estimate_tcount(self.graph)
